...
const lightQuestions = [
  {
    label: 'Uma curiosidade pra come?ar',
    question: 'Qual dessas coisas voc? curte mais?',
    options: [
  ...
  },
  {
    ...
    question: 'Qual dessas coisas mais te ajuda a distrair a cabe?a?',
    options: [
  ...
  {
    label: 'Uma entrada r?pida',
    question: 'Se voc? pudesse escolher uma pausa agora, qual seria?',
    options: [
  ...
  },
  {
    ...
    question: 'Qual dessas coisas combina mais com voc? quando quer dar uma respirada?',
    options: [
  ...
  },
  {
    ...
    question: 'Se voc? pudesse escolher uma companhia leve agora, qual seria?',
    options: [
      { label: 'Musica', value: 'musica' },
  ...
  {
    label: 'So pra come?ar',
    question: 'Qual dessas coisas voc? escolheria agora sem pensar muito?',
    options: [
      { label: 'Musica', value: 'musica' },
      { label: 'Comida boa', value: 'comida boa' },
      { label: 'Ar livre', value: 'ar livre' },
  ...
  },
  {
    ...
    question: 'Quando voc? quer se distrair um pouco, pra onde costuma ir primeiro?',
    options: [
      { label: 'Musica', value: 'musica' },
